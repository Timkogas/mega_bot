...
class TelegramBotApp {
    ...
    private async _sendMessageOnMenu(chatId: number, dbUser: IUserDb): Promise<void> {
        try {
            ...
            const text = `✌️<b> Добро пожаловать в МЕГА Экополис!</b>\n\nЭто меню для навигации по чат-боту. Мы подготовили для вас несколько заданий. <b>Чтобы начать их выполнения, жмите на кнопку «Задания» 👇</b>\n\nВы можете <b>пригласить в наш чат-бот своих друзей</b> – вместе путешествовать по просторам МЕГА Экополиса веселее! А чтобы узнать, кто вместе с вами выполняет задания и сколько набирает баллов, обращайся к «Таблице лидеров».\n\nМЕГА Экополис ждет вас! 💕`
    ...
    private async _sendMessageOnTaskTwo(chatId: number, dbUser: IUserDb): Promise<void> {
        try {
            ...
            const text = `<b>Задание #2. МЕГА Место</b>\n\nАпсайклинг, кастомизация одежды совместно с художником и многое другое ждет вас в МЕГА Месте!\n\nВыбирайте лекции и мастер-классы, прими участие хотя бы в одном и получи уникальный код от куратора, чтобы заработать баллы.\n\nРасписание мастер-классов и запись: <a href="https://mega.ru/events/2023/35992/ekaterinburg/">https://mega.ru/events/2023/35992/ekaterinburg/</a>\n\nДобро пожаловать в МЕГА Экополис! 👐`
